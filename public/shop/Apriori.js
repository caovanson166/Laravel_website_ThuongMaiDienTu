        ...
        list.forEach((item)=>{
            for(var i = 0; i < h.length; i++){
                if(item == h[i].product_id){
                    ...
                    html += `
                    <li>
                        <a href="http://localhost:8080/nckh/`+h[i].file +`/` +h[i].name_file +`" class="w100 mb-5 flex">
                            <div>
                                <img class="img-se" src="http://localhost:8080/nckh/public/assets/upload/`+h[i].main_img+`">
                            </div>
                            <div class="pm">
                                <div>
                                    <p class="p1">
            ...
            <div class="featured__phone__product__item" style="height:auto">
                    ...
                    <a href="http://localhost:8080/nckh/`+h[i].file +`/` +h[i].name_file +`">
                    <img src="http://localhost:8080/nckh/public/assets/upload/`+h[i].main_img+`" alt="`+h[i].name+`"></a>
                </div>
                <div class="featured__phone__product__desc">
                    <div class="featured__phone__product__desc__title">
                        <a href="http://localhost:8080/nckh/`+h[i].file +`/` +h[i].name_file +`" class="featured__phone__product">
                            `+h[i].name+`
                        </a>
                    </div>
